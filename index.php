...
<div class="flex min-h-full items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
  <div class="w-full max-w-md space-y-8">
    <div>
      <img class="mx-auto h-12 w-auto" src="https://tailwindui.com/img/logos/mark.svg?color=indigo&shade=600" alt="Tienda Design">
      <h2 class="mt-6 text-center text-3xl font-bold tracking-tight text-gray-900">Bienvenido a Tienda Design</h2>
    ...
    <form class="mt-8 space-y-6" action="#" method="POST">
      <div class="-space-y-px rounded-md shadow-sm">
        <div>
          ...
          <input id="email-address" name="usuario" required class="relative block w-full appearance-none rounded-none rounded-t-md border border-gray-300 px-3 py-2 text-gray-900 placeholder-gray-500 focus:z-10 focus:border-indigo-500 focus:outline-none focus:ring-indigo-500 sm:text-sm" placeholder="Correo">
        </div>
        <div>
    ...
    <!-- <?php
    $queryUsuario =
        "SELECT usuarios.apellido FROM usuarios where apellido='Perez'";
