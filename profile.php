                        ...
                        <form action="#" method="POST">
                            <div class="shadow sm:overflow-hidden sm:rounded-md">
                                <div class="space-y-6 bg-white px-4 py-5 sm:p-6">
                                    <div class="grid grid-cols-3 gap-6">
                                        <div class="col-span-3 sm:col-span-2">
                                            <label for="company-website"
                                                class="block text-sm font-medium text-gray-700">Sitio
                                                Web</label>
                                    ...
                                    <div>
                                        <label for="about" class="block text-sm font-medium text-gray-700">Sobre mi</label>
                                        <div class="mt-1">
                                            <textarea id="about" name="about" rows="3"
                                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
                                                placeholder="you@example.com"></textarea>
                                        </div>
                                        <p class="mt-2 text-sm text-gray-500">Una breve descripción de tu perfil</p>
                                    </div>
                                    <div>
                                    ...
                                    <div>
                                        <label class="block text-sm font-medium text-gray-700">Foto de tapa</label>
                                        <div
