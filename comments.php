...
$respComments = mysqli_query($sqlConnect, $queryComments );
while ($comment = mysqli_fetch_assoc($respComments)){
  $comments .= '
  ...
  <div class="px-3 min-w-[80%] max-w-[80%]">
    <div class="bg-white rounded-2xl px-10 py-8 shadow-lg hover:shadow-2xl transition duration-500">
      ...
      <div class="flex justify-between items-center">
        ...
        <p class="mt-4 text-md text-gray-600">' .$comment['comentario'] . '</p>
      </div>
    </div>
  </div>
';
